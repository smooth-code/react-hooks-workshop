...
<div>
  <a style={{ textDecoration: 'none' }} href="https://github.com/oliviertassinari">
    <FontAwesomeIcon icon={faGithub} /> @oliviertassinari
  </a>
  {' | '}
  <a style={{ textDecoration: 'none' }} href="https://twitter.com/olivtassinari">
...
<dl>
  <dt>React Hook</dt>
  <dd>
    <em>/ɹiːˈækt/ /hʊk/</em> • A special function that allows to interact with new React features inside a component.
  </dd>
</dl>
