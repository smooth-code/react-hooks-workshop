...
```js
const [value, setValue] = useState(0) // 0 est la valeur par défaut
```
...
# Exercice 7 - Gestion du state avancée
...
# Je veux une status bar à la place du header
