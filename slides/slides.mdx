...
- 2010 - Jordan Walke crée React (Reason)
- 2011 - React est utilisé sur le feed Facebook
- 2012 - React est utilisé sur Instagram
...
> Solution officielle pour gérer le data-fetching
...
> Un Hook React est une fonction qui commence par "use" et qui peut être utilisée à l'intérieur d'un composant fonctionnel React.
...
> Il est possible de créer un composant non-contrôlé à partir d'un composant contrôlé.

---

> Toujours privilégier les composants contrôlés.
...
# Exercice 9 - Raccourcis clavier

---

# Exercice 10 - Debounce
