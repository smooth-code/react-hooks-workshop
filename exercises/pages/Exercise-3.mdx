...
Pour récupérer les données, nous utiliserons la librairie [axios](https://github.com/axios/axios), cela permet de faire des requêtes HTTP de façon simple et d'assurer une compatibilité sur tous les navigateurs.
